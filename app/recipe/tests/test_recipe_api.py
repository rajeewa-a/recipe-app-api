...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        """Test uploadimg an image to recipe"""
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Lankan Vegetable Curry')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Beans om toast')
        ...
        recipe3 = sample_recipe(user=self.user, title='Fish and steak')
